...
- Any Google product enjoyed by its users for being convenient, easy to use, and win-win (RIP [Google Domains](https://9to5google.com/2023/06/15/google-domains-squarespace/))
