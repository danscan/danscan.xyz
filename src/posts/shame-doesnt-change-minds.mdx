export const meta = {
  title: 'Shame Does\'t Change Minds',
  slug: 'shame-doesnt-change-minds',
  date: new Date('2023-05-15'),
};

> Caveat: Just thinking back on writing this from 1 month later, it's probably a stupid post. Discount it accordingly.
